...
declare -A singleCombinations
declare -A doubleCombinations
declare -A tripleCombinations

singleCombinations=(["H"]=0 ["T"]=0)
doubleCombinations=(["HH"]=0 ["TT"]=0 ["HT"]=0 ["TH"]=0)
tripleCombinations=(["HHH"]=0 ["HHT"]=0 ["HTH"]=0 ["HTT"]=0 ["THH"]=0 ["THT"]=0 ["TTH"]=0 ["TTT"]=0)
